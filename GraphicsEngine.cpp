...
bool GraphicsEngine::init()
{
	...
	for (UINT driver_type_index = 0; driver_type_index < num_driver_types;)
	{
		...
		++driver_type_index; //for performance increase
	}
	if (FAILED(res))
	{
		return false;
...
bool GraphicsEngine::createShaders()
{
	...
	D3DCompileFromFile(L"shaders.fx", nullptr, nullptr, "vsmain", "vs_5_0", NULL, NULL, &m_vsblob, &errblob);
	D3DCompileFromFile(L"shaders.fx", nullptr, nullptr, "psmain", "ps_5_0", NULL, NULL, &m_psblob, &errblob);
